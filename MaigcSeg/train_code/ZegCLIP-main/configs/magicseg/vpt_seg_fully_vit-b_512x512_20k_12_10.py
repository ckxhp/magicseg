_base_ = [
    '../_base_/models/zegclip.py', '../_base_/datasets/magicseg_512x512.py',
...
model = dict(
    ...
    ft_backbone = False,
    exclude_key='prompt',
    load_text_embedding='configs/_base_/datasets/text_embedding/magicseg.npy'
)
